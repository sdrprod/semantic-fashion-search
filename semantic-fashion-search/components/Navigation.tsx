...
const categories: NavCategory[] = [
  {
    ...
    subcategories: [
      ...
      { label: 'Tops & Blouses', query: 'tops blouses' },
      { label: 'Pants & Jeans',  query: 'pants jeans' },
  ...
  },
  {
    ...
    subcategories: [
      ...
      { label: 'Flats & Loafers',   query: 'flats loafers' },
  ...
  },
  {
    ...
    query: 'accessories',
    subcategories: [
      { label: 'Handbags & Totes', query: 'handbags totes' },
      { label: 'Scarves & Wraps',  query: 'scarves wraps' },
